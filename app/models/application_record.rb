class ApplicationRecord < ActiveRecord::Base
  ...
  enum region_type: [:Head, :Body, :Physa, :Mesenteries, :Amputation, :Nematosome, :Tentacle]
  enum sublocalisation_type: [:Ectoderm, :Endoderm, :Nuclei_mb, :Cell_mb, :Nuclei, :Cytoplasm]
  enum cell_type: [:Epithelial, :Cnidocyte, :Neuronal, :Gland, :Muscle, :Germline, :Stem]
end
